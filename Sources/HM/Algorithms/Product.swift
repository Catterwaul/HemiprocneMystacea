...
@inlinable
public func product<Base1: Collection, Base2: Collection, Base3: Collection>(
...
@inlinable
public func product<Base1: Collection, Base2: Collection, Base3: Collection, Base4: Collection>(
